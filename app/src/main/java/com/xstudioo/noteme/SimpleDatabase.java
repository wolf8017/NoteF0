...
public class SimpleDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "NoteF0";
    private static final String TABLE_NAME = "NoteMe";
...
//chỉnh sửa ghi chú
    public int editNote(Note note){
        ...
        Log.d("Chỉnh sữa", "Chỉnh sửa tiêu đề: -> "+ note.getTitle() + "\n ID -> "+note.getId());
